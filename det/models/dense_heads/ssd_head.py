...
class SSDHead(AnchorHead):
    ...
    def __init__(self,
        ...
        self.cls_out_channels = num_classes + 1  # background class
        ...
        # background label should be 0 or num_classes
        ...
        # set sampling=False for anchor target
        self.sampling = False
        if self.train_cfg:
    ...
    def loss_single(self, cls_score, bbox_pred, anchors, labels, label_weights,
        ...
        neg_inds = (labels == self.background_label).nonzero().view(-1)  # get index of labels==background.

        num_pos_samples = pos_inds.size(0)
        num_neg_samples = self.train_cfg.neg_pos_ratio * num_pos_samples  # neg = pos * ratio
