...
# from det.core import eval_map,eval_recalls
...
class CustomDataset(Dataset):
    ...
    def load_annotations(self, ann_file):
        ...
        return mtcv.load(ann_file)

    def load_proposals(self, proposal_file):
        """Load proposal from proposal file."""
        return mtcv.load(proposal_file)
    ...
    def get_classes(cls, classes=None):
        ...
        if isinstance(classes, str):
            ...
            class_names = mtcv.list_from_file(classes)
    ...
    def evaluate(self,
        ...
        eval_results = {}
        print("The evaluation for bbox recall and precision is not supported now.")
        # if metric == 'mAP':
